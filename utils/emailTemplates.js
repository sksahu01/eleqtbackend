  ...
  return {
    ...
    message: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
        <h2 style="color: #2d2d2d;">Hi ${name},</h2>

        <p style="font-size: 16px; color: #333;">
          Welcome to <strong>ELEQT</strong>! We're excited to have you on board.
        </p>

        <p style="font-size: 16px; color: #333;">
          Please verify your email address to complete your registration and start using all features.
        </p>
        ...
        <p style="font-size: 13px; color: #aaa;">
          This message was sent to ${user.email} by ELEQT. If you have any questions, feel free to reach out to our support team.
        </p>
      </div>
    `,
  };
...
export const resetPasswordEmailTemplate = (user, resetToken) => {
  const name = user.name || "User";
  const appUrl = config.FRONTEND_URL;
  const resetPasswordUrl = `${appUrl}/auth/password/reset/${resetToken}`;
